...
public class VehicleManagerTest {
	...
	@Test
	public void testExistByVehicleId_Exists() {
	    // Arrange
	    String vehicleId = "12345";
	    Mockito.when(vehicleRepository.existsByVehicleId(vehicleId)).thenReturn(true);

	    // Act
	    boolean result = vehicleManager.existByVehicleId(vehicleId);

	    // Assert
	    Assert.assertTrue(result);
	    Mockito.verify(vehicleRepository, Mockito.times(1)).existsByVehicleId(vehicleId);
	}

	@Test
	public void testExistByVehicleId_NotExists() {
	    // Arrange
	    String vehicleId = "12345";
	    Mockito.when(vehicleRepository.existsByVehicleId(vehicleId)).thenReturn(false);
	...
	public void testGetVehicles() {
		...
		Mockito.when(vehicleRepository.findAllActive(Mockito.any(Pageable.class))).thenReturn(pageVehicles);
		Mockito.when(
		...
		Mockito.verify(vehicleRepository, Mockito.times(1)).findAllActive(Mockito.any(Pageable.class));
	...
	@Test
	public void testGetVehicles_Failure() {
	    // Arrange
	    int no = 0;
	    int size = 10;
	    String sortBy = "vehicleId";
	    ...
	    Mockito.verify(vehicleRepository, Mockito.times(1)).findAllActive(Mockito.any(Pageable.class));
	    Mockito.verify(modelMapperService.forResponse(), Mockito.times(0)).map(Mockito.any(Vehicle.class),
	            Mockito.eq(VehicleResponse.class));
	}
	...
	@Test
	public void testCheckTeamLeaderRole_TeamLeaderRoleExists() {
		// Arrange
		String authorizationHeader = "Bearer token";
		...
		// Act
		boolean result = vehicleManager.checkTeamLeaderRole(authorizationHeader);
	...
	@Test
	public void testCheckTeamLeaderRole_TeamLeaderRoleNotExists() {
		// Arrange
		String authorizationHeader = "Bearer token";
		String responseBody = "ROLE_ADMIN, ROLE_USER";
